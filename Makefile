...
dump-logs-scylla: ## Dump Scylla test service logs
	$(Q)docker compose $(COMPOSE_SCYLLA_FILES) logs

dump-logs-dynamodb: ## Dump DynamoDB test service logs
	$(Q)docker compose $(COMPOSE_DYNAMODB_FILES) logs
